...
<template>
  <div class="space-y-4">
    <!-- Folder browser -->
    <div class="border dark:border-neutral-700 rounded-lg max-h-[300px] overflow-y-auto">
      <!-- Root option -->
      <button
      ...
      >
        ...
        <span class="font-medium text-stone-900 dark:text-stone-100">My Files (Root)</span>
      </button>
      
      <div v-if="loading" class="px-4 py-8 text-center text-stone-500">
      ...
      <div v-else-if="folders.length === 0" class="px-4 py-4 text-center text-sm text-stone-500 dark:text-stone-400">
      ...
      <template v-else>
        ...
        >
          ...
          <span class="text-stone-700 dark:text-stone-300">{{ folder.name }}</span>
        </button>
      </template>
    </div>
    ...
    <div class="text-sm text-stone-600 dark:text-stone-400">
      Save to: <span class="font-medium text-stone-900 dark:text-stone-100">
