...
<template>
  <div
    ref="menuRef"
    class="fixed bg-white dark:bg-neutral-800 rounded-lg shadow-lg border dark:border-neutral-700 py-1 min-w-48 z-50"
    :style="{ left: `${x}px`, top: `${y}px` }"
  >
    <!-- Open -->
    <button
      @click="handleAction('open')"
      class="w-full px-4 py-2 text-left text-sm hover:bg-stone-100 dark:hover:bg-neutral-700 flex items-center gap-3"
    >
